                      ...
                      <tbody>
                        <tr>
                          <?php
                            $catego = "u_n";
                          ?>
                          <form action="delete_data_users.php?categoria=<?= $catego?>" method="post">
                          <?php  
                              include '../conect.php';
                              $sql = "SELECT * FROM usuarios WHERE Categoria = 'u_n' order by Id DESC";
          ...
          <form action="save_data_users.php" method="post">
              ...
              <div class="form-group">
                ...
                <select class="form-control col-6" id="exampleFormControlSelect1" name="user_function">
                  <option selected>Utilizador normal</option>
                  <option>Administrador</option>
                </select>
              </div>
              <div class="form-group">
                <label for="exampleFormControlInput4">Palavra-passe</label>
                <input type="password" class="form-control" id="exampleFormControlInput4" placeholder="palavra-passe" minlength="6" name="user_password">
...
<?php 
  ...
  while($linhas_data = $query->fetch_assoc()){
    ...
    $senha = $linhas_data['PalavraPasse'];
  }
?>
<!-- Fim Modal update -->
