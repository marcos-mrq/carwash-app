      ...
      <div class="card card_border mb-5">
        <div class="cards__heading">
          ...
          <div class="container-fluid">
            <form action="data_user_actualization.php?id=<?=$id?>" method="post" class="d-flex form-cad">
             
              <div class="form-group">
                <label for="exampleFormCont­rolInput1">Nome Completo</label>
                <input type="text" class="form-control"­ id="exampleFormContr­olInput1" name="input-name" placeholder="Nome" minlength="6" value="<?= $nome?>"> 
              </div>

              <div class="form-group">
                <label for="exampleFormCont­rolInput2">Número de Telefone</label>
                <input type="tel" class="form-control"­ id="exampleFormContr­olInput2" name="input-phone" placeholder="999999999" pattern="[0-9]{3}[0-9]{3}[0-9]{3}" value="<?= $tel?>" maxlength="9">
              </div>

              <div class="form-group">
                <label for="exampleFormCont­rolInput3">Email</label>
                <input type="email" class="form-control"­ id="exampleFormContr­olInput3" name="input-email" placeholder="name@example.com" value="<?= $email?>"> 
              </div> 

              <div class="form-group">
                <label for="exampleFormCont­rolInput4">Palavra-passe</label>
                <input type="password" class="form-control"­ id="exampleFormContr­olInput4" name="input-pass_word" minlength="6" value="<?= $pass?>">
                <button class="fa fa-eye btn" type="button" onclick="ver()"></button>
              </div>
...
<script>
  function ver(){
      if(document.getElementById('exampleFormContr­olInput4').type == "password"){
        document.getElementById('exampleFormContr­olInput4').type = "text";
      }else{
        document.getElementById('exampleFormContr­olInput4').type = "password";
      }
  }
</script>
