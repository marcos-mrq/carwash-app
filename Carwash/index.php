<?php session_start();?>
 ...
 <?php  
    ...
    $sql_users = "SELECT * FROM usuarios WHERE Categoria = 'u_n'";
...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
    ...
    <div class="welcome-msg pt-3 pb-4">
      <h1>Seja Bem-vindo ao Sistema <span class="text-primary">CarWash Control</span></h1>
              ...
              <div class="card card_border border-primary-top p-4" id="list">
                ...
                <h3 class="text-secondary number"> 
                  <?php 
                   ...
                   $now = new DateTime('+24 Hours');
                   $last_hours = new DateTime('-24 Hours');
                   
                   $agora = $now->format('Y-m-d H:i');
                   $ultimashoras = $last_hours->format('Y-m-d H:i');
                   $car_cad = 0;
                   $select = "SELECT *FROM veiculo where Data_registro Between '$ultimashoras%' and '$agora%'";
                   $quer = $Conn->query($select);
                   $car_cad = mysqli_num_rows($quer); 
                   echo "$car_cad veículo(s)";
                  ?></h3>
                <p class="stat-text">veículos cadastrados(24h)</p>
              </div>
            </div>
          </div>
        </div>
    ...
    $sql_jan = "SELECT * FROM veiculo WHERE MONTH(Data_registro) = 01 AND YEAR(Data_registro) = '$ano_corrente'";
      ...
      datasets: [
        {
          ...
          backgroundColor: ['#4755ab','#ff4f81','#4755ab','#ff4f81','#4755ab','#ff4181','#4755ab','#ff4181','#4755ab'],
          tension: 0.1
        }
      ]
    }
