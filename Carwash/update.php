  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="search.php">Consultas</a></li>
        <li class="breadcrumb-item" aria-current="page">Actualização de Dados</li>
      </ol>                   
    </nav>
    ...
    <section class="pricing">
      <div class="card card_border mb-5">
        <div class="cards__heading">
          <h3>Actualizar dados dos Veículo</h3>
        </div>
          <div class="container-fluid">
             <?php 
              ...
              ?>
            <form action="data_actualization.php?id=<?=$id?>" method="post" class="d-flex form-cad">
             

              <div class="form-group">
                <label for="exampleFormCont­rolInput1">Marca o veículo</label>
                <input type="text" class="form-control"­ id="exampleFormContr­olInput1" name="input-marca" value="<?= $marca ?>"> 
              </div>

              <div class="form-group">
                <label for="exampleFormCont­rolInput2">Modelo do veículo</label>
                <input type="text" class="form-control"­ id="exampleFormContr­olInput2" name="input-modelo" value="<?= $modelo ?>">
              </div>

              <div class="form-group">
                <label for="exampleFormCont­rolInput1">Matrícula</label>
                <input type="text" class="form-control"­ id="exampleFormContr­olInput1" name="input-matricula" value="<?= $matricula ?>"> 
              </div> 

              <div class="form-group">
                <label for="exampleFormCont­rolInput1">Cilindragem</label>
                <input type="text" class="form-control"­ id="exampleFormContr­olInput1" name="input-cilindragem" value="<?= $cilind ?>"> 
              </div>
